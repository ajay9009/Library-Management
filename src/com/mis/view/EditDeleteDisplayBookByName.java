...
/**
 * Servlet implementation class EditDeleteDisplayBookByName
 */
@WebServlet("/EditDeleteDisplayBookByName")
public class EditDeleteDisplayBookByName extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditDeleteDisplayBookByName() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			 ...
			 out.println("<html>");
		    ResultSet rs=BookController.displayAllByName(request.getParameter("un"));
		    if(rs.next())
