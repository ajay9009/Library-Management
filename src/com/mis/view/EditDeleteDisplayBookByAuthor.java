...
/**
 * Servlet implementation class EditDeleteDisplayBookByAuthor
 */
@WebServlet("/EditDeleteDisplayBookByAuthor")
public class EditDeleteDisplayBookByAuthor extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditDeleteDisplayBookByAuthor() {
        super();
		...
		// TODO Auto-generated method stub
		 PrintWriter out=response.getWriter();	
			try{
				 ...
				 out.println("<html>");
			    ResultSet rs=BookController.displayAllByAuth(request.getParameter("auth"));
			    if(rs.next())
