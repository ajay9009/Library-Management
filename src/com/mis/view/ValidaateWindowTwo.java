...
/**
 * Servlet implementation class ValidaateWindowTwo
 */
@WebServlet("/ValidaateWindowTwo")
public class ValidaateWindowTwo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ValidaateWindowTwo() {
        super();
